    ...
    public class CryptoHelper
    {
        ...
        public static KeyPair GenerateKeyPair(string keyType = null)
        {
            ...
            return new KeyPair()
            {
                ...
                PublicKey = KeyToString(pubKey, keyType, keyType == "R1" ? "PUB_R1_" : "VAKA")
            };
        }
        ...
        public static string PubKeyBytesToString(byte[] keyBytes, string keyType = null, string prefix = "VAKA")
        {
        ...
        public static byte[] PubKeyStringToBytes(string key, string prefix = "VAKA")
        {
