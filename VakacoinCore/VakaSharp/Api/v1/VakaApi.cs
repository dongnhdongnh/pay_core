...
namespace VakaSharp.Api.v1
{
    ...
    { 
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_info", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_account", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_code", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_abi", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_raw_code_and_abi", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/abi_json_to_bin", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/abi_bin_to_json", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_required_keys", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_block", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_block_header_state", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_table_rows", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_currency_balance", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_currency_stats", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_producers", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_producer_schedule", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/get_scheduled_transactions", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/chain/push_transaction", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/history/get_actions", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/history/get_transaction", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/history/get_key_accounts", Config.HttpEndpoint, APIVersion);
        ...
        {
            var url = string.Format("{0}/{1}/history/get_controlled_accounts", Config.HttpEndpoint, APIVersion);
