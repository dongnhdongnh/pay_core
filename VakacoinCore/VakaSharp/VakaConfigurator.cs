...
namespace VakaSharp
{
    ...
    {
        /// <summary>
        /// http or https location of a novakad server providing a chain API.
        /// </summary>
        ...
        /// <summary>
        /// number of seconds before the transaction will expire. The time is based on the novakad's clock. 
