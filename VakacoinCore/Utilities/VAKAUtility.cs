...
{
    public static class VAKAUtility
    {
        ...
        public static DateTime VAKATimeToUTC(Int64 slotTime)
        {
            Int64 interval = 500;
        ...
        public static decimal VakaToDecimal(string vakaString)
        {
                ...
                if (vakaString == null)
                    ...
                    clean_core_liquid_balance = vakaString.Trim().Replace(" VAKA", "");

                return decimal.Parse(clean_core_liquid_balance);
         
        }

        public static List<dynamic> FilterFields<T>(List<string> properties, List<T> data) where T: IVAKATable
        {
