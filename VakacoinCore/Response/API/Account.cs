    ...
    public class Account : IEOAPI
    {
        ...
        public decimal core_liquid_balance_ulong { get {
                ...
                if (core_liquid_balance == null)
                    ...
                    clean_core_liquid_balance = core_liquid_balance.Trim().Replace(" VAKA", "");
        ...
        public decimal net_weight_decimal
        {
            get
            {
                ...
                if (net_weight == null)
                    ...
                    net_weight_clean = net_weight.Trim().Replace(" VAKA", "");
        ...
        public decimal cpu_weight_decimal
        {
            get
            {
                ...
                if (cpu_weight == null)
                    ...
                    cpu_weight_clean = cpu_weight.Trim().Replace(" VAKA", "");
        ...
        public decimal net_amount_decimal
        {
            get
            {
                ...
                if (net_amount == null)
                    ...
                    net_amount_clean = net_amount.Trim().Replace(" VAKA", "");
        ...
        public decimal cpu_amount_decimal
        {
            get
            {
                ...
                if (cpu_amount == null)
                    ...
                    cpu_amount_clean = cpu_amount.Trim().Replace(" VAKA", "");
