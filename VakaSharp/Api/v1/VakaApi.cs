    ...
    public class VakaApi
    {
            ...
            JsonSerializerSettings jsonSettings = null)
        {
            ...
            return new GetCurrencyBalanceResponse()
                {Assets = await HttpHelper.PostJsonAsync<List<string>>(url, data, jsonSettings)};
        }
            ...
            JsonSerializerSettings jsonSettings = null)
        {
            ...
            return new GetCurrencyStatsResponse()
                {Stats = await HttpHelper.PostJsonAsync<Dictionary<string, CurrencyStat>>(url, data, jsonSettings)};
        }
        ...
        public async Task<GetScheduledTransactionsResponse> GetScheduledTransactions(
            GetScheduledTransactionsRequest data, JsonSerializerSettings jsonSettings = null)
        {
