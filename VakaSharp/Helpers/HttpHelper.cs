...
namespace VakaSharp.Helpers
{
    public class HttpHelper
    {
        ...
        public static async Task<TResponseData> PostJsonAsync<TResponseData>(string url, object data,
            CancellationToken cancellationToken, JsonSerializerSettings jsonSettings = null)
        {
            HttpRequestMessage request = BuildJsonRequestMessage(url, data);
        ...
        public static async Task<TResponseData> PostJsonWithCacheAsync<TResponseData>(string url, object data,
            bool reload = false, JsonSerializerSettings jsonSettings = null)
        {
        ...
        public static async Task<TResponseData> PostJsonWithCacheAsync<TResponseData>(string url, object data,
            CancellationToken cancellationToken, bool reload = false, JsonSerializerSettings jsonSettings = null)
        {
            string hashKey = GetRequestHashKey(url, data);
