...
namespace Vakapay.UnitTest
{
    ...
    class ETHRpcTest
    {
        ...
        public async void SendTransactionAsync()
        {
            ...
            //Trace.Write(JsonHelper.SerializeObject(output));
            var output = _etheRpc.SendTransactionAsync(new EthereumWithdrawTransaction()
                {Amount = 10, ToAddress = "0x3a2e25cfb83d633c184f6e4de1066552c5bf4517"});
        ...
        {
            var balance = _etheRpc.GetBalance("0x3a2e25cfb83d633c184f6e4de1066552c5bf4517");
            var ba = 0;
            balance.Data.HexToInt(out ba);
            ...
            while (true)
            {
                var balance2 = _etheRpc.GetBalance("0x3a2e25cfb83d633c184f6e4de1066552c5bf4517");
                // Thread.Sleep(1000);

                balance2.Data.HexToInt(out ba2);
