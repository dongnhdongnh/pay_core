...
namespace Vakapay.UnitTest
{
    ...
    public class VakacoinRpcTest
    {
        ...
        [TestCase( Status.STATUS_SUCCESS , "useraaaaaaaa", "useraaaaaaab", "0.0001 VAKA", "unittest", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")]
        [TestCase( Status.STATUS_SUCCESS , "useraaaaaaab", "useraaaaaaaa", "0.0001 VAKA", "unittest", "5JUNYmkJ5wVmtVY8x9A1KKzYe9UWLZ4Fq1hzGZxfwfzJB8jkw6u")]
        [TestCase( Status.STATUS_ERROR , "useraaaaaaaa", "useraaaaaaab", "0.0001 VAKA", "wrong private key", "5JUNYmkJ5wVmtVY8x9A1KKzYe9UWLZ4Fq1hzGZxfwfzJB8jkw6u")] // wrong private key
        [TestCase( Status.STATUS_ERROR , "useraaaaaaaa", "useraaaaaaab", "0.0001 LIEM", "wrong symbol", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")] // wrong symbol
        [TestCase( Status.STATUS_ERROR , "useraaaaaaaa", "useraaaaaaab", "0.001 VAKA", "wrong precision(4)", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")] // wrong precision(4)
        [TestCase( Status.STATUS_ERROR , "useraaaaaaaa", "useraaaaaaab", "0.0000 VAKA", "Zero Amount", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")] // Zero amount
        [TestCase( Status.STATUS_ERROR , "", "useraaaaaaab", "0.0001 VAKA", "Sender blank", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")] // Sender Blank
        [TestCase( Status.STATUS_ERROR , "useraaaaaaaa", "", "0.0001 VAKA", "Receiver blank", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")] // Receiver Blank
        [TestCase( Status.STATUS_ERROR , "useraaaaaaaa", "vaka.n.exist", "0.0001 VAKA", "Receiver not exist", "5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr")] // Receiver not exist
